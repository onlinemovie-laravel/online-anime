...
{{-- <a class="button-register" rel="nofollow" href="/members/register.html"></a><a class="button-login" rel="nofollow" href="members/login.html"></a><a class="button-login-with-fb" rel="nofollow" href="{{route('index')}}"></a> --}}
    ...
    <div class="block update">
        <div class="widget-title">
            ...
            <!-- <span class="tabs">
                ...
                <div class="tab" data-name="muanay" data-target=".block.update .content">
                    <div class="name"><a title="anime mùa này" href="#">Mùa này</a></div>
                </div>
                <div class="tab" data-name="muatruoc" data-target=".block.update .content">
                    <div class="name"><a title="anime mua tuoc" href="#">Mùa trước</a></div>
                </div>
                <div class="tab" data-name="phimcu" data-target=".block.update .content">
                    <div class="name"><a title="MOVIE" href="#">Bộ cũ</a></div>
                </div>
            </span> -->
        </div>
        <div class="clear"></div>
