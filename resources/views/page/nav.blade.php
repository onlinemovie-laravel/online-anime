        ...
        <ul id="mega-menu-1">
            ...
            <li>
                ...
                <div class="dropdown-menu" aria-labelledby="status">
                    <a class="dropdown-item text-danger" href="./tim-nang-cao/?status=complete&season=&year=&sort=popular">Hoàn thành</a>
                    <a class="dropdown-item text-danger" href="./tim-nang-cao/?status=ongoing&season=&year=&sort=popular">Đang tiến hành</a>
                </div>
            </li>
            <li>
                ...
                <div class="dropdown-menu" aria-labelledby="moreview">
                    <a class="dropdown-item text-danger" href="./danh-sach/xem-nhieu-trong-ngay.html">Ngày</a>
                    <a class="dropdown-item text-danger" href="./danh-sach/xem-nhieu-trong-tuan.html">Tuần</a>
                    <a class="dropdown-item text-danger" href="./danh-sach/xem-nhieu-trong-thang.html">Tháng</a>
                    <a class="dropdown-item text-danger" href="./danh-sach/xem-nhieu-trong-mua.html">Mùa Này</a>
                    <a class="dropdown-item text-danger" href="./danh-sach/xem-nhieu-trong-nam.html">Năm Này</a>
                    <a class="dropdown-item text-danger" href="./tim-nang-cao/?status=&season=&year=2018&sort=popular">Năm Trước</a>
                    <a class="dropdown-item text-danger" href="./tim-nang-cao/?status=&season=7&year=2018&sort=popular">Mùa trước</a>
                    <a class="dropdown-item text-danger" href="./tim-nang-cao/?status=&season=&year=&sort=popular">Tất cả</a>
                </div>
            </li>
            <li>
